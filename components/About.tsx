    ...
    return (
        <>
            <section className='bg-[#FDF7F8] relative py-20'>
                ...
                <div className='maxW flex flex-col h-full gap-10 items-center lg:flex-row lg:gap-20'>

                    <article className='lg:mt-[180px] lg:w-1/2'>
                        <img src="/fabrica-img.png" alt="" />
                    </article>

                    <article className='lg:mt-[180px] lg:w-1/2'>
                        <h1 className='font-semibold text-5xl uppercase mt-2 text-center lg:text-left'>Levando o <span className='text-RedP'>sorvete</span> a um novo patamar</h1>
                        <p className='mt-4 text-center lg:text-left'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda vitae a nobis exercitationem blanditiis aut officia veritatis eum, necessitatibus possimus rerum vero expedita consequuntur. Facilis laudantium laboriosam maiores ex adipisci. Excepturi voluptates corrupti aliquid porro vel nisi mollitia dolorem ipsam.</p>
                        <p className='mt-2 text-center lg:text-left'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore voluptatum repellat corporis similique voluptatem voluptatibus quo minima doloremque, temporibus nobis?</p>
